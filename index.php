                    ...
                    <div class="row align-items-center no-gutters">
                        <div class="col-xl-5 col-lg-6">
                            <div class="main-menu d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <li><a class="active" href="index.php" style="font-size: 20px; text-shadow: 0px 2px 4px black; rgba(00,00,00.100)">home</a></li>
                                        <li><a href="kamar.php" style="font-size: 20px; text-shadow: 0px 2px 2px black; rgb(10,4,2,3.10)">kamar</a></li>
                  ...
                  <div id="carouselExampleAutoplaying" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="img/dashboard2.jpg" alt="First slide" width="1000" height="700">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/elite.jpg" alt="Second slide" width="1000" height="700">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/restoran2.jpg" alt="Third slide" width="1000" height="700">
                      </div>
                      </div>

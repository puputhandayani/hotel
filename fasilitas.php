                            ...
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a class="active" href="fasilitas.php" style="font-size: 20px; text-shadow: 0px 2px 2px black; rgb(10,4,2,3.10)">fasilitas</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-5 col-lg-4 d-none d-lg-block">
                            <div class="book_room">
                                ...
                                <div class="book_btn d-none d-lg-block">
                                    <a class="popup-with-form" href="#test-form" style="border-radius: 8px; padding: 20px; box-shadow: 0 6px 8px 0 rgba(2,1,2,3.3)">Pesan Kamar</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="img/fasilitas/meeting-room.jpg" alt="First slide" width="1000" height="700">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/fasilitas/bar.jpeg" alt="Second slide" width="1000" height="700">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/fasilitas/restoran.jpg" alt="Third slide" width="1000" height="700">
                      </div>
                      </div>

...
<div class="wrapper">
  ...
  <aside class="main-sidebar elevation-3">
    ...
    <a href="#" class="brand-link">
            <span  class=" brand-text font-weight-light" style="text-center"><b><b>Nebula Hotel</b></b></span>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
        <img src="../template1/img/comment/1.png" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block"><b>Resepsionis</b></a>
        </div>
      </div>

...
<head>
    ...
    <title>Nebula Hotel</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <!-- <link rel="manifest" href="site.webmanifest"> -->
    <link rel="shortcut icon" type="image/x-icon" href="img/kamar/logo1.png">
...
<body>
    ...
    <header>
        <div class="header-area ">
            <div id="sticky-header bg-primary" class="main-header-area">
                        ...
                        <div class="col-xl-5 col-lg-6">
                            <div class="main-menu  d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        <ul id="navigation">
                                        <li><a href="index.php" style="font-size: 20px; text-shadow: 0px 2px 2px black; rgb(10,4,2,3.10)">home</a></li>
                                        <li><a class="active" href="kamar.php" style="font-size: 20px; text-shadow: 0px 2px 2px black; rgb(10,4,2,3.10)">kamar</a></li>
                                        <li><a href="fasilitas.php" style="font-size: 20px; text-shadow: 0px 2px 2px black; rgb(10,4,2,3.10)">fasilitas</a></li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-5 col-lg-4 d-none d-lg-block">
                            <div class="book_room">
                                <div class="book_btn d-none d-lg-block">
                                    <a class="popup-with-form" href="#test-form" style="border-radius: 8px; padding: 20px; box-shadow: 0 3px 8px 0 rgba(2,1,2,3.3)">Pesan Kamar</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
    ...
    <div id="carouselExampleAutoplaying" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="img/kamar/kamar4.jpg" alt="First slide" width="1000" height="700">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/kamar/kamar2.jpg" alt="Second slide" width="1000" height="700">
                      </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="img/kamar/kamar1.jpg" alt="Third slide" width="1000" height="700">
                      </div>
                      </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="section_title text-center mb-100">
                        <span><h1><b>Daftar Kamar<b></h1></span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="single_rooms">
                <div class="room_thumb">
                    ...
                    <div class="room_heading d-flex justify-content-between align-items-center">
                        ...
                        <a href="#test-form" class="popup-with-form">Pesan</a>
                ...
                <div class="row">
                    <div class="col-xl-8 col-md-7 col-lg-9">
                        <p class="copy_right">
                                ...
                                </script>© 2023 by puput handayani</a> 
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </p>
                    </div>
                    <div class="col-xl-4 col-md-5 col-lg-3">
                        <div class="socail_links">
                            <ul>
                                <li>
                                <a href="https://instagram.com/puputndyhii/">
                                <i class="fa fa-instagram"></i>
                                <a href="https://facebook.com/puput hndyni/">
                                <i class="fa fa-facebook"></i>
                                <a href="https://whatsapp.com/081387272981/">
                            ...
                            <form >
                                <div class="row">
                                    ...
                                    <div class="input-group mb-5">
                                        <select class="form-select wide" name="tipe_kamar" id="default-select" class="">
